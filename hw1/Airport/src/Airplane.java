...
public class Airplane {
    ...
    private Runways m_runway;

    public Airplane(String name, Airport depart, Airport destination, int numPassMax, int speed) {
        m_name = name;
        m_depart = depart;
    ...
    public Runways getRunway() {return m_runway;}

    public void setRunway(Runways runway) { m_runway = runway;}

    public void clearRunway() {m_runway = null;}
